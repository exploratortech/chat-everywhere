...
const appInsights = new ApplicationInsights({
  config: {
    instrumentationKey: process.env
      .NEXT_PUBLIC_APP_INSIGHTS_INSTRUMENTATION_KEY as string,
    ...
    properties: {
      ...
      ConnectionString: `InstrumentationKey=${
        process.env.NEXT_PUBLIC_APP_INSIGHTS_INSTRUMENTATION_KEY as string
      };IngestionEndpoint=https://koreasouth-0.in.applicationinsights.azure.com/`,
      Name: 'chat-everywhere',
