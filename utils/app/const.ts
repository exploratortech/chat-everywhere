...
export const PERSISTENT_SYSTEM_PROMPT = "Return an error message if a function's response matches the pattern: `<name>:error` where `<name>` is the name of the function.";
