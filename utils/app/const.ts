...
export const PERSISTENT_SYSTEM_PROMPT = "Respond with an error message if a function's response matches the pattern: `<name>:error:<message>` where `<name>` is the name of the function and `<message>` is the error message.";
