        ...
        >
          ...
          >
            <div className="flex min-h-full items-center justify-center text-center mobile:block">
              ...
              >
                <Dialog.Panel className="w-full max-w-[80vw] xl:max-w-3xl tablet:max-w-[90vw] h-[calc(80vh-100px)] transform overflow-hidden rounded-2xl text-left align-middle shadow-xl transition-all bg-neutral-800 text-neutral-200 flex mobile:h-[100dvh] max-h-[750px] tablet:max-h-[unset] mobile:!max-w-[unset] mobile:!rounded-none">
                  <Sidebar
